...
class TableValues:
    ...
    def tabell_måste_hitta(self, material, konst):
    ...
    def avsnitt_6_1_6_2(self, tvärsnitt, type):
        if type == "solid timber" or type == "glued laminated timber" or type == "LVL":
            if tvärsnitt == "rectangular":
                k_m = 0.7
            else:
                k_m = 1
        else:
...
class enhet(TableValues, Sections):
    ...
    #def ändra_tvärsnitt(self):


class SS_EN_1995_1_1(enhet, skapa_laster.BeräknaLaster):
    ...
    def ekv_3_1(self):
        self.rho_k = self.tabell_måste_hitta(self.material, "rho_k")
        self.h = self.dimensioner[1]
    ...
    def ekv_6_1(self):
        ...
        self.f_t_0_k = self.tabell_måste_hitta(self.material, "f_t_0_k")
    ...
    def ekv_6_2(self):
        ...
        self.f_c_0_k = self.tabell_måste_hitta(self.material, "f_c_0_k")
    ...
    def ekv_6_3(self):
        ...
        self.f_c_90_k = self.tabell_måste_hitta(self.material, "f_c_90_k")
    ...
    def ekv_6_11(self):
        ...
        self.f_m_k = self.tabell_måste_hitta(self.material, "f_m_k")
    ...
    def ekv_6_13(self):
        ...
        self.f_v_k = self.tabell_måste_hitta(self.material, "f_v_k")
    ...
    def ekv_6_21(self):
        ...
        self.E_0_05 = self.tabell_måste_hitta(self.material, "E_0_05")
    ...
    def ekv_6_31(self):
        ...
        self.G_0_05 = self.tabell_måste_hitta(self.material, "G_mean")
